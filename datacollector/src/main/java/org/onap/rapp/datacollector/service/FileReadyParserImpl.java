...
public class FileReadyParserImpl extends ParserAbstractClass implements VesParser {
    ...
    /**
     * Creates individula event from FileReadyEvent data
     *
    ...
    /**
     * As MeansType will be selected by its its positin in the list we need to make sure that MeasTypesList's size is the same size of MeasResults
     *
     * @param measInfo measurement Info object
     * @param measValue measurement Value object
    ...
    /**
     * Average interval between last and strat day, divided by number of measurements
     *
     * @param fileReadyEvent object created from PM Mapper response
